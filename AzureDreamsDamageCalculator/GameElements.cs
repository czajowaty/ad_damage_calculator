namespace AzureDreamsDamageCalculator
{
    public struct UnitsTraits
    {
        ...
        public static readonly UnitTraits Ashra = new UnitTraits()
        {
            ...
            ExpGivenGrowth = 0x0F,
            NativeGenus = Genus.Water,
            NativeSpell = SpellsTraits.Mirror,
            Talents = Talents.StrengthIncreased,
            IsEvolved = true,
            Liftable = false,
            Pushable = false,
        ...
        public static readonly UnitTraits Univern = new UnitTraits()
        {
            ...
            ExpGivenGrowth = 0x14,
            NativeGenus = Genus.Wind,
            NativeSpell = SpellsTraits.Blind,
            IsEvolved = true,
            Liftable = false,
            Pushable = false,
        ...
        public static readonly UnitTraits Noise = new UnitTraits()
        {
            ...
            ExpGivenGrowth = 0x0C,
            NativeGenus = Genus.Wind,
            NativeSpell = SpellsTraits.Sleep,
            Liftable = false,
            Pushable = true,
        ...
        public static readonly UnitTraits Cyclone = new UnitTraits()
        {
            ...
            ExpGivenGrowth = 0x11,
            NativeGenus = Genus.Wind,
            NativeSpell = SpellsTraits.Grave,
            Liftable = false,
            Pushable = true,
        ...
        public static readonly UnitTraits Manoeva = new UnitTraits()
        {
            ...
            ExpGivenGrowth = 0x0F,
            NativeGenus = Genus.Water,
            NativeSpell = SpellsTraits.Forth,
            Liftable = false,
            Pushable = false,
        ...
        public static readonly UnitTraits Barong = new UnitTraits()
        {
            ...
            ExpGivenGrowth = 0x0D,
            NativeGenus = Genus.Fire,
            NativeSpell = SpellsTraits.Poison,
            Liftable = true,
            Pushable = true,
